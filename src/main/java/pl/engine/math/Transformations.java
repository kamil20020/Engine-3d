...
public class Transformations {
    ...
    public static Matrix getRotateZMatrix(int angleDegree){
    ...
    public static Vector3 rotateZ(Vector3 point, int angleDegree){

        Matrix rotationMatrix = getRotateZMatrix(angleDegree);
